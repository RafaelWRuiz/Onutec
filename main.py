...
""")
    ...
    # callback do select (fora do form, permitido)
    def _on_change_pais():
        st.session_state["pending_pais_id"] = st.session_state.get("sel_pais_id")

    # re-insere temporariamente o país escolhido se ele sumiu
    ...
    # ====== Formulário: apenas dados e submit ======
